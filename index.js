...
console.log("Addition: " + add(numb1, numb2));        // Output: 15
console.log("Subtraction: " + subtract(numb1, numb2)); // Output: 5
console.log("Multiplication: " + multiply(numb1, numb2)); // Output: 50
console.log("Division: " + divide(numb1, numb2));      // Output: 2
